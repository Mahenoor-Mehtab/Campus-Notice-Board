...
export default function EditNotice() {
  ...
  // Fetch existing notice data to pre-fill form
  useEffect(() => {
    if (!id) return
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-white">
        <Navbar />
        <div className="max-w-3xl mx-auto px-4 py-20 text-center text-gray-900 font-bold animate-pulse">
          Loading Notice Data...
        </div>
      </div>
    )
      ...
      <div className="max-w-2xl mx-auto px-4 py-10">
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 sm:p-8">
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-700 mt-1">Update the fields below to modify the campus notice.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <textarea
                required
                rows={6}
                placeholder="Write the complete details of the notice here..."
                value={body}
            ...
            <div className="flex justify-end gap-3 pt-4 border-t border-gray-200">
              ...
              >
                {isSubmitting ? 'Saving Changes...' : 'Update Notice'}
              </button>
            </div>
          </form>
        </div>
